# Generated manually to bootstrap custom user model
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=20,
                        validators=[django.core.validators.RegexValidator("^[0-9\\-\\+\\(\\)\\s]+$", message="Используйте допустимый формат номера")],
            ...
            managers=[("objects", src.apps.accounts.models.UserManager())],
        ),
    ]
